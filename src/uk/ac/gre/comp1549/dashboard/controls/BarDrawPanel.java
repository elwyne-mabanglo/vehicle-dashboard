 ...
 * @version 2.0
 */
public class BarDrawPanel extends JPanel implements Indicator {
    ...
    public void paintComponent(Graphics g) {
        ...
        //GradientPaint redtoyellow = new GradientPaint(0 + (float) barx.getWidth()* 0.5F, 0, Color.RED, (float) barx.getHeight()* 0.10F, 0, Color.YELLOW);
        GradientPaint redtoyellow = new GradientPaint(0, //x1
                                                      0 + (float) barx.getHeight()* 0.3F,    //y1
                                                      Color.YELLOW,                        
                                                      0, //x2
                                                      150 + (float) barx.getHeight()* 0.1F,  //y2
                                                      Color.RED);
        ...
        Line2D valueIndicator = new Line2D.Double(padding / 2F, padding + (barHeight * (barMaxValue - value) / barMaxValue), barLength + (padding * 1.5F), padding + (barHeight * (barMaxValue - value) / barMaxValue));
